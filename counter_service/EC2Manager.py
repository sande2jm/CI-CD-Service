...
class EC2Manager():
	def __init__(self):
		...
		self.public_dns_filepath = 'config/counter_service_public_dns_name.txt'
		self.version = None
	...
	def getVersion(self):
		...
		self.cmdList['run image'] = 'sudo docker run -d -p 80:80 sande2jm/counter_service:' + self.version
		self.cmdList['pull image'] = 'sudo docker pull sande2jm/counter_service:' + self.version
